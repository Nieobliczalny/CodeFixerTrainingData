...
for (int k = 0; k < 10; ++k)
{
qA87o_Ccj = (int)floor(Bf_Jc_6Px0);
}
}
}
}
...
case 'd':
case 'D':
EmPW65 = elS_((unsigned short)-629875691, MS7959Q2kX, EmPW65, (short)-457360847, (unsigned short)1159554776);
break;
case 'e':
case 'E':
...
case 'f':
case 'F':
NyI7v5X = (int)floor(RIX9_V);
break;
case 'g':
case 'G':
NyI7v5X = (int)floor(qA87o_Ccj);
break;
case 'h':
case 'H':
...
{
i--;
FtvZsg9y = elS_((unsigned short)279973251, 123028196, O6Jyxid1i4, (short)-1791820270, (unsigned short)576433182);
}
while (i >= 0);
}

if (O6Jyxid1i4 >= Bf_Jc_6Px0)
{
{
int j = 1;
do
{
j--;
if (qA87o_Ccj <= -2008196779)
{
R9_K_ = sW332 * 626676636;
}
}
while (j >= 0);
}
...
std::cout << elS_(GeTsmic, -1060823732, -993551210, kr6zdT4Pn, (unsigned short)778224569) << PB4gxdN1 << elS_(GeTsmic, -861893182, -737747707, (short)747162248, R9_K_) << q_DMJEZm << std::endl;
