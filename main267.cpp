...
int main(void) {
 ...
 unsigned char H50_4HWu2 = (unsigned char)813785321;
    long    VoUy    =    -1833468000;
  unsigned char  QeXMnO  =  (unsigned char)724084396;
  double  GR4963  =  -781728869;
 int Gul9nSH = 370510698;
    unsigned long long    tQ1HfvTI    =    -1762961412;
 ...
 float a_A071t = -1869057126;
  ...
  unsigned short  JDy4kn14t  =  (unsigned short)-1360899642;
    long double    PBc623kZ    =    2105446162;
	unsigned char	s5uR1a6T	=	(unsigned char)2029031862;
	unsigned char	J8Au3e0_QB	=	(unsigned char)756913728;
  unsigned int  ZIo2AHKM3  =  -126805276;
 char faUE7g = (char)-227919064;
 ...
 long long SZ7zu_ = 299099256;
  ...
  long long  zH8t  =  1783244227;
	char	y3RPJ	=	(char)-154406644;
    float    Vot1    =    -2122590702;
  long  kwFc5rtxnS  =  540358914;
 ...
 unsigned char l4O65gB = (unsigned char)1380205294;
  char  IPpoMaDT  =  (char)-361432490;
    unsigned long long    wFMT0    =    1283944575;
    unsigned short int    bxFi5QL1E_    =    (unsigned short)674279641;
  float  uEv8  =  -770615;
    unsigned short int    iWl2r9w3    =    (unsigned short)-957586457;
 ...
 char W4425wVPI = (char)-1413079904;
    short    wVmvQXgQ    =    (short)-685942810;
	long double	HhLsL65	=	-79715780;
	unsigned long	V72p	=	-1265016720;
	unsigned char	wKcI_nad	=	(unsigned char)471834425;
	unsigned short	Tr8Mg3nSl	=	(unsigned short)1101767239;
 unsigned char N30Bq4 = (unsigned char)-261818075;
...
try
{
W4425wVPI = Vot1 / 1874370118;
}
catch (int& errorCode)
{
HZla = SZ7zu_ >> b582oTvV;
}
}
catch (int& errorCode)
{
...
do
{
if (wKcI_nad != 309556631)
{
if ((sBKkXo == 1470812435) && ((V72p & -1436416993) && (l4O65gB >= 506307616)))
{
bxFi5QL1E_ |= 1067073618;
}
}
else
{
...
if ((kwFc5rtxnS > K8isgAAj6) && (GPJqs80 <= 553173612))
{
HhLsL65 = ivhmemha_();
}
else if (S2K12D <= tQ1HfvTI)
{
try
{
...
try
{
if (((uEv8 <= K8isgAAj6) && (GPJqs80 & 496132892)) || ((X_k_P != 1014750651) || (bxFi5QL1E_)))
{
ZHEk618 = (int)floor(a_A071t);
}
}
catch (int& errorCode)
{
sBKkXo = ziUQeT / 1540760795;
}

if (((H50_4HWu2 <= K8isgAAj6) && (PBc623kZ >= y3RPJ)) && (UVl5xw1 <= K8isgAAj6))
{
...
PXNu98 = k8cj8 % 164334801;

std::cout << "Tpm9" << kwFc5rtxnS << "J19VU9dem4" << llnUl5cM90(hZJN) << "NdPzbB" << std::endl;
switch (ZIo2AHKM3)
{
case 0:
