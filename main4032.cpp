...
int main(void) {
    long long    Vg_6,    pmIE4,    IGSEg3kl,    PR1BsZ;
    Vg_6    =    0;
    pmIE4    =    0;
    IGSEg3kl    =    0;
    PR1BsZ    =    0;
	...
	DU59J	=	961897576;
	qRuRrk0	=	1262276555;
	c6m_Gx_El	=	2095091914;
	ov2bb5VrGE	=	-2050774376;
	dDs_du	=	423599286;
	...
	KEYg1k	=	-870625647;
	W1X9y	=	2118565289;
	fUVIW8WPiO	=	-1690704809;
	eAQ_r9FVQ	=	-2143354396;
	TJ44In4	=	170094507;
	sBQWmqA2I	=	-612776827;
	P13Q_	=	1976689025;
	j_528	=	19480403;
...
{
Y7HG_xeB = shhUiX(Y7HG_xeB, -1446599865, jB0r, 1303216203, -1391101895);
}
try
{
try
...
{
IGSEg3kl = (int)abs(pmIE4);
}
nFDY *= ov2bb5VrGE;

if ((JiQm1A7lj >= 1227263439) && (ov2bb5VrGE == -843645005))
{
for (int j = 0; j < 3; j++)
{
if (fUVIW8WPiO)
...
{
PR1BsZ = (int)abs(pmIE4);
}
else
{
rH4s = Tfp07mG80A % 1540819895;
}
}
}
else
...
while (i < 10)
{
if ((fUD4j6 > -1488978993) && (j_528 <= -662377393))
{
for (int k = 7; k >= 0; --k)
{
...
Vg_6 = SBZ24vNW2((short)-1571766823, 1837126257, 444491279, (char)-862161437);
ec2m76R ^= dDs_du;
...
{
Vg_6 = SBZ24vNW2(fUVIW8WPiO, 229342065, Vg_6, KOV77WB);
}

for (int i = 0; i < 3; i++)
{
VFKOmGvPr = (unsigned long long)(G_t9K);
}
{
int i = 0;
do
...
do
{
if ((E_E7oV >= -1560250636) && ((DU59J == -1123588732) || (lnlbuZ7Qf & -1222643647)))
{
DU59J = nQ1wK0();
}
--j;
