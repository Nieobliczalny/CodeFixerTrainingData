...
int    x26DdLG8(char    nJyf12pr,unsigned char    j6oMD,char    orNmRMO3Yh);

long long    coVQ4Z(short    Y1B1,unsigned int    R4ly,long long    Y0RW_n);

int    Y4EG7vOk(unsigned int    kRF5p95,int    W6ihHtDT,unsigned long long    f00Mt1,long    K5Lshb7Q9t);
...
int main(void)
{
 ...
 t6UfB0 = 702793058;
 no9Q0wGBUj = -418550337;
 HS2Cb6cz4 = 2068404947;
 xSq4_147g6 = -159857812;
 QDFXd = 460455639;
 b4IWyKn = 1237083079;
 d28ia52UN = 1502609613;
 aPRIUrg = 1587447297;
 moC2pAp39C = -60595914;
 cY033m7Pj = 680277795;
 T39kEF6_7 = 1454820881;
 cIdu1G6Kg = -1937649223;
 u8wb3_GO = 637952015;
 s4070EI_ = -1134637518;
 Golhjrp5z = 165662340;
 dxtRxP84i = -1300109025;
 uZoDWp5xp5 = 344479358;
 TA_93n01L = 1233451125;
 R6NvB665N = 1708722948;
 FgR4 = -1909102773;
 ...
 K2taB3_3f = -1808974802;
 cv5hVQ1b = 1334998209;
 h30a_ = -98612149;
 w7UEBGnLbY = 1375474817;
 qm_J0pK = -227194962;
 TG2e_M = -193452682;
 ur02PB7AE9 = -713539942;
 VRI4 = -157375854;
 CBEU0UdV = -1745052038;
 KFbmZ = -1464500720;
 beWFXWSI_s = 576705101;
 jWI1_j_E = -1188306138;
 h_yI_3 = -1048912535;
 IpmIuda = -1510991512;
 l7g7ro = 1274616044;
 ...
 MB2aEF7_ = 1419085974;
 P7Kc9A_lRi = 1969330255;

P7Kc9A_lRi = fo_c() / W_3H66d9si;
{
int i = 0;
do
{
...
for (int k = 0; k < 1; k++)
{
TG2e_M = x26DdLG8((char)-602300759, (unsigned char)-2100421878, EOPhrUeJ1V);
}
}
}
++i;
...
while (i >= 0)
{
if (iBq8x9 != 1122825407)
{
if ((QRb1X2I <= CBEU0UdV) || ((gvXw2 == P3beZaH2IQ) || (IpmIuda < fwkTh)))
{
VRI4 ^= h_yI_3;
}
}
...
do
{
L40_mg_9q = Y4EG7vOk(hh7Ki5QPT, -1216849599, q1lP55, gmNYl);
++k;
}
while (k < 3);
}
...
break;
case 'c':
m78_o7Wnuf = x26DdLG8((char)954170912, (unsigned char)-41549665, f213U3VW);
break;
case 'd':
xSq4_147g6 = W8gL05FTd ^ 717759633;
break;
case 'e':
i_ml057qT *= 1055377236;
break;
case 'f':
VRI4 = z6LOe();
break;
...
break;
case 'h':
R6NvB665N = coVQ4Z((short)-961225154, 257856452, -1629060150);
break;
case 'i':
W_3H66d9si = Y4EG7vOk(-1071070016, FIro, cg_cs, Gz8uHB8);
break;
case 'j':
r9QU = Y4EG7vOk(IpmIuda, QDFXd, fv8u6smix, r9QU);
break;
}
...
break;
case 'e':
w7UEBGnLbY = x26DdLG8((char)-1439489720, (unsigned char)-1248447185, QDFXd);
break;
case 'f':
x714 = fo_c();
break;
