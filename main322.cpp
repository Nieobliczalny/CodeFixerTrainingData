...
int main(int argc, char** argv) {
 ...
 gEVM9LEo = -539608255;
  ...
  sImCkDs  =  (unsigned short)-2018569957;
    unsigned char    U1be;
 ...
 k5cVRl = -1105790663;
  ...
  long double  kBdki9_;
  kBdki9_  =  1339547745;
    unsigned long long    lH09V8f2;
    lH09V8f2    =    1155266334;
	char	WlvkE;
	WlvkE	=	(char)-321479954;
 ...
 float sTZ0p97r;
 sTZ0p97r = 1565245797;
 unsigned long long O4o_JGUO;
 O4o_JGUO = 2015469000;
 unsigned short int kwx1mV;
 kwx1mV = (unsigned short)471286525;
 long long a8v6ZE0ax;
 a8v6ZE0ax = 0;
 char FUI2Nef;
...
case 'b':
case 'B':
Kt_1LOz = iF_Q0 << 1812856011;
break;
case 'c':
case 'C':
Yp20AOT = M9_U(Yp20AOT, O4o_JGUO, ZA9y, XfHOj, 1954937588);
break;
case 'd':
case 'D':
iCE2x9roW %= a86HONc3;
...
case 'e':
case 'E':
RO82ZvLN = M9_U(RO82ZvLN, 998676404, lH09V8f2, LWxSyqj085, -1672150308);
break;
case 'f':
case 'F':
O4o_JGUO |= 716959755;
...
case 'h':
case 'H':
a8v6ZE0ax = R64PGT(S1xb3YM2WJ);
break;
case 'i':
case 'I':
LWxSyqj085 = R64PGT(S1xb3YM2WJ) ^ 489880930;
break;
case 'j':
case 'J':
Zx9E = (int)abs(E_bO8);
...
cout << M9_U(S1xb3YM2WJ, 1873930051, (unsigned short)-2116387674, lH09V8f2, 1046747601) << "BnDX" << R64PGT(S1xb3YM2WJ) << R64PGT(S1xb3YM2WJ) << endl;
...
do
{
a8v6ZE0ax = (long long)(kBdki9_ * a8v6ZE0ax);
++j;
}
while (j < 4);
}
...
try
{
cout << Y8Iujma82(UKTlV_) << E_bO8 << endl;
}
catch (int& errorCode)
{
...
O4o_JGUO = hc_ftO(O4o_JGUO, (short)197485070, -508070525);
...
{
Yp20AOT = (Yp20AOT > 1261870697) ? vwS8G467_b : WlvkE;
}
}
}
...
cout << M9_U(peNhc, kwx1mV, (unsigned short)-1323958374, Kt_1LOz, lH09V8f2) << R64PGT((short)2045309255) << "EE1fw" << endl;
{
int i = 0;
while (i < 2)
{
...
{
j++;
cout << sTZ0p97r << "TB_I22V" << M9_U(peNhc, 1634654065, (unsigned short)316432791, 159046856, lH09V8f2) << endl;
}
}
}
while (i < 5);
