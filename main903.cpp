...
int main() {
 ...
 ts2quR2n7 = 819129772;
  ...
  PvFs950R  =  388726037;
    unsigned char    kk5x1;
    kk5x1    =    (unsigned char)-652626029;
    char    aP9ElvS2Y4;
    aP9ElvS2Y4    =    (char)1944056839;
    int    cd92X8qD;
    cd92X8qD    =    1264818745;
	long long	vizw97VMx;
	vizw97VMx	=	-160432652;
 ...
 lYrRU6d = (unsigned char)-2004896373;
  unsigned char  n2TFU;
  n2TFU  =  (unsigned char)-214136267;
 int W6_Bs0Z2_E;
 W6_Bs0Z2_E = 53201180;
 ...
 Ib4A0f6 = 1358493086;
	...
	Y07a_7__H	=	-53490817;
 short BRev0cmt;
 BRev0cmt = (short)1978571419;
 long long rTZsH;
 rTZsH = 146297381;
  short int  qd25KYxbM9;
  qd25KYxbM9  =  (short)861504941;
 unsigned char Of3GhE_h;
 Of3GhE_h = (unsigned char)-1850574493;
  unsigned long  R_e3khq7;
  R_e3khq7  =  742562639;
  int  tMlSrFf;
  tMlSrFf  =  -75719796;
	unsigned short	f_YV24I7;
	f_YV24I7	=	(unsigned short)-119877599;
    int    V65THw4;
    V65THw4    =    696635224;
    short    sDsY23_c9;
    sDsY23_c9    =    (short)-1354926851;
	char	QEwWpr3W2H;
	QEwWpr3W2H	=	(char)-262984559;
    int    hfLHIK_i;
    hfLHIK_i    =    -1180548184;
  long long  Zs7Y_VP1;
  Zs7Y_VP1  =  -452744398;
 ...
 uQ7Q3_k = 1714123867;
    char    ON743;
    ON743    =    (char)1367663044;
 double u30_m52aq;
 u30_m52aq = 1134320645;
    char    bV3rwS06_;
    bV3rwS06_    =    0;
...
{
case 0:
OzugmW29 = saxwxd0hM0 * f_YV24I7;
break;
case 1:
PvFs950R = (int)ceil(XJk25Ynn7);
break;
case 2:
T57E7R2cIU >>= ON743;
break;
case 3:
zNW6I = (int)floor(XJk25Ynn7);
break;
case 4:
...
break;
case 8:
cd92X8qD = W6_Bs0Z2_E + 1146816079;
break;
}
}
else
{
Zs7Y_VP1 = (int)abs(d6rqj4v);
}
}
while (i < 4);
}
if (OzugmW29 != -1317665516)
{
{
int j = 0;
do
...
std::cout << aP9ElvS2Y4 / rf30HQZ << std::endl;
std::cout << "CJdqE85" << std::endl;
JhY_7 = (unsigned short)(UBTYgA0 + (655497840));

if (S3C76YML4 != bV3rwS06_)
{
{
int j = 0;
do
...
{
k--;
WeWeB5BdiU ^= 278008758;
}
}
}
else
{
Ib4A0f6 = qd25KYxbM9 * kc6j0Dorns;
}
}

f_YV24I7 = QEwWpr3W2H + 1010466578;
...
{
++k;
cd92X8qD = (ts2quR2n7 >= -1450121673) ? -838351225 : 111910409;
}
}
}
}
...
do
{
std::cout << Of3GhE_h << "AXL8d" << d6rqj4v << std::endl;
--j;
}
while (j >= 0);
}
