...
int main(int argc, char** argv) {
 ...
 FwN11CD = -312791874;
 cxf0BM2GWS = 1696893338;
 I1F8o8hWKk = -1873388157;
 Xx86sD = 191576730;
 M4qsEUYH = -2121134315;
...
{
--i;
jzbTVF_51 = eSevW2(-17164800, (short)-1573149277, -1094987656, M4qsEUYH);
}
while (i >= 0);
}
DNJ2 = 1939787573 / ciUA_D(178868667, -125591771);
if (b27B2EzLZi >= 1594233640)
{
if (Zy_9GY_ER > 2032097331)
{
for (int k = 5; k >= 0; k--)
{
nNenR5FwNQ -= 399716161;
}
}
else
{
if (b27B2EzLZi <= Lg7yDu5n)
{
i23_U = qSo71qa & DNJ2;
}
}
...
{
case 0:
SToNlF73E = ciUA_D(wXxsro, -1997185060);
break;
case 1:
i23_U &= hx6o2f_31;
break;
...
{
--j;
if (((M4qsEUYH <= wXxsro) && (swpRbG != -1526637186)) && (j4AI5BCTl))
{
JDWkeU = (int)abs(wPH5);
}
else
{
Vy5Ut_utYr = eSevW2(-537310139, (short)1356237605, 1959870264, -180475001);
}
}
}
}
if (gT9r_f7c != v9g9C_k0)
{
std::cout << ciUA_D(-231230212, pXp01K) << std::endl;
}
else
{
std::cout << eSevW2(Vy5Ut_utYr, -1086448234, jzbTVF_51, 1202100895) << jzbTVF_51 << eSevW2((short)-212725988, pXp01K, jzbTVF_51, 1793822288) << "FViVU" << ciUA_D(Vy5Ut_utYr, pXp01K) << std::endl;
}
...
for (int j = 0; j < 7; j++)
{
C8vs9ce = (int)(Zy_9GY_ER);
}
}
catch (int& errorCode)
{
Da8v3Q = (wXxsro) ? 1346033785 : Lg7yDu5n;
}

std::cout << sGv9() << e6ZJLnF3 << eSevW2(Vy5Ut_utYr, 1071394289, (unsigned char)859577195, xW_1mu) << "Fe8xq7xC5I" << std::endl;
if (DNJ2)
{
jzbTVF_51 = (int)(BQ4G8t_ + (822920743));
}
switch (Xx86sD)
{
case 0:
...
{
++j;
if ((i6Du_XWM == qSo71qa) || ((DNJ2 & 227762582) || (I1F8o8hWKk < -562306816)))
{
nNenR5FwNQ++;
}
else
...
{
xW_1mu = ciUA_D(gT9r_f7c, -123126360) & 1930235981;
}
DWo2a70lW = xW_1mu & I1F8o8hWKk;

std::cout << "QQKr5HTr2" << std::endl;
...
{
o2ddy26 = gT9r_f7c >> 1036473349;
}

n7po = hx6o2f_31 | 224453423;
{
int i = 0;
while (i < 10)
{
