...
#define  jYXzw  (-1321944703)
#define	bLjYL7g_	(-611801658)
#define  FG541  (0)
#define	z6OGk43C5n	(-1567630327)
#define	cllJ4T9	(-60892041)
...
int main() {
  unsigned short  J_ibS2;
  J_ibS2  =  (unsigned short)189682325;
    double    q_3V_5;
    q_3V_5    =    -1920265825;
 short HOnoc8s622;
 ...
 U1y_FX = (unsigned char)-2072884863;
  ...
  long long  AV8sZi;
  AV8sZi  =  -802348896;
  unsigned long  p0ze585;
  p0ze585  =  1085235116;
  int  v8oYg;
  v8oYg  =  1902420717;
	unsigned short int	NX6A;
	NX6A	=	(unsigned short)389499615;
  unsigned long long  HyOf3_5T;
  HyOf3_5T  =  152813264;
  double  uv9JJA6tZC;
  uv9JJA6tZC  =  -653259653;
  double  OdqE2;
  OdqE2  =  -249405971;
  char  A2p89RE;
 ...
 t5NS = 309203699;
 long c51s02Rv5a;
 c51s02Rv5a = -2080855268;
    long    boIj;
    boIj    =    -259877165;
    float    e0UcuY;
    e0UcuY    =    266558532;
    short int    QI_1_yx1Dt;
    QI_1_yx1Dt    =    (short)919819474;
    long long    jmcCGmk2;
    jmcCGmk2    =    1621899501;
    float    tAFfx;
    tAFfx    =    -1450156918;
 ...
 Bz3hVAaDk = 320700755;
  ...
  jgJknZ  =  1821684554;
    ...
    n94Fyy83Cn    =    (unsigned char)466448727;
	unsigned long long	Pn5ox;
	Pn5ox	=	1923936355;
	long double	nIM3X3jOA;
	nIM3X3jOA	=	-1063927759;
	double	QA6Nfz;
	QA6Nfz	=	-182482473;
    float    F6hND;
    F6hND    =    154184958;
    unsigned short    Rh7U3H1;
    Rh7U3H1    =    (unsigned short)-31179629;
...
QI_1_yx1Dt = Bz3hVAaDk / C25xXF2R0U(QI_1_yx1Dt);
for (int i = 6; i >= 0; i--)
{
if (p_EwRhU1S9 > L1Qj_)
{
...
else if (nIM3X3jOA <= -2003818398)
{
std::cout << jmcCGmk2 << "XM9L" << C25xXF2R0U((short)-1960846260) << NX6A << std::endl;
}
...
else if ((jmcCGmk2 >= AV8sZi) || ((nIM3X3jOA >= 1068593477) && (HOnoc8s622)))
{
{
int k = 0;
do
...
{
ZFl4hI4g = C25xXF2R0U((short)-702606297);
}
}
...
try
{
nIM3X3jOA = (long double)(FG541 + (bLjYL7g_));
}
catch (int& errorCode)
{
FO1G2LUu = (int)ceil(QA6Nfz);
}
}
}
...
{
ZFl4hI4g = C25xXF2R0U(W29RtQc_);
}
else
{
if (O08S1MB & -1247776305)
{
for (int k = 0; k < 10; k++)
{
zfiN7V = C25xXF2R0U((short)753329774);
}
}
}
...
do
{
h5H_7 = C25xXF2R0U((short)-949619626);
--i;
}
while (i >= 0);
}
