...
#define  n_27z7rk  (0)
#define i4_b4DRF (1386303581)
#define	x99G7BtJD	(-402692548)

using namespace std;

unsigned long	wrK0Y89(long long	Vwm_E66O,unsigned char	KOnF2x3CF,long	P79nxNV)	{
	return	0;
}

unsigned short int  N_T_(char  FFgx,unsigned long  NT9nH,short  njJmNRH2GS,short int  zom4BdLaD,char  ew1TW_)  {
  return  (unsigned short)-2057284963;
}
...
int main(void) {
  ...
  a7sZ7  =  792684794;
	...
	a8MI3Pv	=	(unsigned short)-394590018;
 unsigned int je3CAe;
 je3CAe = 1248718241;
	long double	czU12q;
	czU12q	=	-740902987;
 ...
 Mm3IJi = (unsigned short)1961422886;
 long long w6p2iH9;
 w6p2iH9 = 124464724;
	float	XV_Y406lz_;
	XV_Y406lz_	=	-1979088449;
 unsigned char c163QrcI;
 c163QrcI = (unsigned char)-1886555382;
  unsigned int  Nh15zs1;
  Nh15zs1  =  0;
    unsigned long long    D4l37iOZ;
    D4l37iOZ    =    -1232892569;
	char	D2lno8;
	D2lno8	=	(char)318928729;
 ...
 ym983VYQO6 = 476391752;
  ...
  fIJeKVBa  =  -205245660;
    ...
    tfYx    =    -1032294754;
    unsigned char    Rt78;
    Rt78    =    (unsigned char)1009183006;
  short  nIBhe_i5x;
  nIBhe_i5x  =  (short)-1500696010;
	long	aZjE94J;
	aZjE94J	=	1367828133;
  unsigned int  Yk1D7X;
  Yk1D7X  =  -1141275084;
    unsigned long long    d2C_71s;
    d2C_71s    =    -849713604;
 unsigned char X_B2d;
 X_B2d = (unsigned char)1863398984;
 long uyP65;
 uyP65 = 0;
  short int  j650B;
  j650B  =  (short)-76000050;
 ...
 iLWQ1Fo = (unsigned short)-1664658592;
	unsigned int	sKGygDB4_;
	sKGygDB4_	=	-736180771;
 short eOA5;
 eOA5 = (short)-345406392;
	float	P8o_zk5R;
	P8o_zk5R	=	-290720854;
	int	fwl4zpJ;
	fwl4zpJ	=	0;
 ...
 ztqGNjD = -373291527;
	short int	pHu_P2qfT;
	pHu_P2qfT	=	(short)-535076490;
 unsigned short i57L7y_eFX;
 i57L7y_eFX = (unsigned short)-1285811503;
 ...
 YDcMq9Ud7F = -299125900;
	...
	DEf8k1__8j	=	(unsigned char)-2094525465;
 unsigned long Bb_8b8vVw2;
 Bb_8b8vVw2 = -2055361968;
...
{
X_B2d = N_T_(639782661, -1105853958, -1469348601, JNJDA, -2011416121);
}
C0w7cC23 = (int)floor(WMijZ1pK5);
...
{
--i;
cout << N_T_((char)1039266249, 1640549317, (short)1556454763, JNJDA, Mm3IJi) << wrK0Y89(X_B2d, i57L7y_eFX, -783733733) << Su9X8AYdnW << uyP65 << endl;
}
}
...
{
SUTKB1_9 = (int)abs(tfYx);
}
{
int i = 2;
while (i >= 0)
{
cout << "Eqik" << aZjE94J << endl;
i--;
}
}
...
{
c163QrcI = N_T_(c163QrcI, kXd2NEN, aZZKgNQ3, a7sZ7, (char)-1746856446);
}
...
try
{
c9V1aj6U8q = wrK0Y89(i57L7y_eFX, c9V1aj6U8q, 132548650);
}
catch (int& errorCode)
{
czU12q = (int)ceil(P8o_zk5R);
}
}
while (i >= 0);
}
...
{
P8o_zk5R = AM66 ^ 639341263;
}
}
}
catch (int& errorCode)
{
Nh15zs1 = wrK0Y89(D2lno8, -1914514254, ar4Cl5d);
}
...
{
case 0:
P8o_zk5R = (int)floor(XV_Y406lz_);
break;
default:
ztqGNjD = (int)abs(h6SSy);
break;
}
}
while (j < 9);
