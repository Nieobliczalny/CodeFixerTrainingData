...
int main(int argc, char** argv) {
	...
	int	prtVU	=	0;
  long long  XV03  =  0;
    unsigned char    W186dc    =    -1582658780;
...
{
i++;
W186dc = cJJb7_7U7c(317087517, (char)1388321166);
}
while (i < 4);
}
...
for (int k = 0; k < 3; k++)
{
W186dc = o0m7wkQ8(-1418746770, prtVU, -966123314, (short)2036973978, -693229384) ^ 646338004;
}
}
...
{
k--;
W186dc = cJJb7_7U7c(450361996, (char)37487603) * 1452293240;
}
while (k >= 0);
}
}
