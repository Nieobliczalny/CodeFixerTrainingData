...
int main() {
 ...
 int gT1BuoV = -811336965;
  ...
  long double  Uw8g  =  596165146;
    unsigned int    Vb_f2s_6    =    704825448;
    long    RCOpA    =    -420605217;
	unsigned long	rb5ed22	=	-150899910;
  int  T5h6  =  0;
  int  VqAA  =  0;
 unsigned short R77J7tpH5 = (unsigned short)2093837918;
 unsigned long long lr78 = -1427879900;
  long double  JQVZ  =  -762902786;
 ...
 double NjLSH = 342742360;
  char  k515  =  (char)-18843564;

std::cout << "p701yg" << jYsXen3C << "Xm9zo77Yw" << y1Sd << std::endl;
...
do
{
if ((W142 > h08Ss0) || ((y1Sd == Uw8g) && (hEXTT5qcW & V_Iv)))
{
y1Sd = (int)abs(EC7r4j);
}
j--;
...
{
cIzcSN = n67k0RiH(-433961815, -973761617, rb5ed22, n6Q54lcmz);
}
{
int i = 8;
do
...
std::cout << JQVZ << n67k0RiH(cIzcSN, (short)-1482207100, rb5ed22, n6Q54lcmz) << std::endl;

if (lr78 == 600621570)
{
try
{
Uw8g = (long double)(Dnoe);
}
catch (int& errorCode)
{
...
{
case 'a':
JQVZ = n67k0RiH(JQVZ, (short)1263250550, (char)1598271557, rb5ed22);
break;
case 'b':
rb5ed22 >>= V_Iv;
break;
...
break;
case 'e':
V_Iv = n67k0RiH(1847107202, EC7r4j, (char)-1845503246, jYsXen3C);
break;
case 'f':
I_wfBW = n6Q54lcmz / m_Gr248;
break;
case 'g':
jYsXen3C = (int)abs(T5h6) + (130751852);
break;
case 'h':
T5h6 = Lp1B5();
break;
...
if (RCOpA != -929607225)
{
if (Hp5h9c_APN & UXqX608m43)
{
NjLSH = (int)floor(Uw8g);
}
}
--i;
}
...
break;
case 2:
cah511 = (int)ceil(n6Q54lcmz);
break;
case 3:
k515 %= Vb_f2s_6;
break;
case 4:
cIzcSN = n67k0RiH(cIzcSN, (short)1534226492, VqAA, Vb_f2s_6);
break;
case 5:
...
if ((W142 == -1265351784) && (y1Sd <= -343458524))
{
...
{
--k;
cah511 = (int)floor(JQVZ);
}
}
}
}

RCOpA = n67k0RiH(T5h6, RCOpA, Dnoe, gT1BuoV);
T5h6 = Lp1B5();
NjLSH = (int)ceil(h08Ss0);

if (cIzcSN & 2033663606)
{
for (int j = 0; j < 6; j++)
{
for (int k = 1; k >= 0; k--)
{
UXqX608m43 = n67k0RiH(T5h6, UXqX608m43, (char)-1949307183, V_Iv);
}
}
}
else
...
{
Y8dy19mA = n67k0RiH(I_wfBW, h08Ss0, Hp5h9c_APN, -2097971656) << 1082309211;
}
}
catch (int& errorCode)
{
...
{
jYsXen3C = n67k0RiH(jYsXen3C, NjLSH, Uw8g, I_wfBW);
}
}
...
{
Uw8g = n67k0RiH(-874700621, RCOpA, (char)-1232601118, VqAA);
}
...
{
R77J7tpH5 = Vb_f2s_6 - 951116248;
}
}
}
}
else if ((NjLSH != lr78) && ((JQVZ != 358180746) && (I_wfBW >= NjLSH)))
{
switch (gT1BuoV)
{
case 'a':
...
break;
case 'b':
JQVZ = hEXTT5qcW - n6Q54lcmz;
break;
case 'c':
jYsXen3C = n67k0RiH(420599774, (short)123370407, NjLSH, rb5ed22);
break;
case 'd':
...
while (i >= 0)
{
jYsXen3C = (short int)(T5h6 + (1710417583));
i--;
}
}
