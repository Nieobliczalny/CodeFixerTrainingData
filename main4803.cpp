...
int main() {
 long w6x39NRve1 = 0;
  char  oGX2Mm  =  -1147844788;
	long long	hr4AV	=	0;
  char  husW9  =  -773556651;
 int iWmy = -920920171;
 ...
 unsigned short int q7_FmP = 396298147;
    unsigned long long    f42s4N    =    1264686545;
 unsigned char PfQ08y = -140118042;
...
for (int j = 5; j >= 0; j--)
{
N_i2dWi = Sq612XC(259292630, N_i2dWi, uPO1sycz);
}
}
catch (int& errorCode)
{
...
{
Ji6131ws2 = Nk7bbcYC8(-1591670161, Ji6131ws2, 525829030, 1687233347);
}
}
}
...
{
j++;
N_i2dWi = Sq612XC(-1570421752, TmqBCbD, -241393060);
}
}
}
else
...
{
--j;
q7_FmP = Sq612XC(q7_FmP, IPVS, -1092667738);
}
}
}
...
try
{
cout << "tZ3Lfy_v5_" << Nk7bbcYC8(q7_FmP, IPVS, -2118381703, -1840015906) << Nk7bbcYC8(357747561, IPVS, TmqBCbD, -988689610) << endl;
}
catch (int& errorCode)
{
p99523J += Ji6131ws2;
...
for (int k = 0; k < 4; ++k)
{
oGX2Mm = Sq612XC(oGX2Mm, uPO1sycz, 1652259563);
}
}
else if (q7_FmP)
{
ndy7 = Sq612XC(1598607077, B_MnSu5Fu, 318226943);
}
else
{
{
