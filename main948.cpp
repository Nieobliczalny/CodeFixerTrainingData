...
#define    TpYNZbhx    (327230594)
#define  A7eh3  (1359913523)
#define Hnx745dNs (2928482)
#define mk1127 (0)
...
int main(int argc, char** argv)
{
 ...
 unsigned short int qI0lal = (unsigned short)-1868585640;
 unsigned short int ljvmZ = (unsigned short)-1027960759;
  unsigned short  Bulr2E3_3R  =  (unsigned short)1655840446;
 ...
 unsigned short int arDReiM = (unsigned short)-1956294317;
  unsigned long long  nSdq14586  =  -617991116;
    long    pv3W    =    184752062;
  unsigned short int  lL82O_  =  (unsigned short)1392915941;
	unsigned short	T6EkD8	=	(unsigned short)-1600197080;
	unsigned long long	RiR4	=	556779069;
 unsigned short ZCrNQarw__ = (unsigned short)-591355749;
  short  N7I29TSWg  =  (short)-1369706721;
...
do
{
q_6OsHE4 = W0n3Z77((unsigned char)-1620169840, (char)-265336260, 2009762196, (unsigned short)-1942390809);
++k;
}
while (k < 7);
}
...
{
cout << W0n3Z77((unsigned char)-1888838104, (char)104729467, RiR4, (unsigned short)1802328875) << l8Ied << endl;
}
else if (uZ9ACYZNU5 < -1780018209)
{
if (tW29pHXP)
{
s_7_xMx = (int)abs(N7I29TSWg);
}
else
{
ljvmZ |= 677578389;
...
{
++k;
q_6OsHE4 = W0n3Z77((unsigned char)1835138136, sT99, -240651152, p_9TNF6);
}
while (k < 9);
}
}
else if (A_WTF5g8 >= 210776682)
{
q_6OsHE4 = W0n3Z77((unsigned char)-654920529, tW29pHXP, 1833865886, (unsigned short)949000259);
}
else if ((ck8s & A7eh3) || ((lL82O_ != 1236532138) && (q_6OsHE4 <= -1016912068)))
{
if (U1K2CG3T4K == mk1127)
{
tW29pHXP = (int)abs(s_7_xMx);
}
else
{
CJc_Bll -= 652226461;
...
{
q_6OsHE4 = W0n3Z77((unsigned char)-333172763, (char)1961136355, -582663663, q_6OsHE4);
}
}
}
return 0;
