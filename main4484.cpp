...
#define  pk05  (0)
#define    Gg6E3yyN7    (1555640499)
#define oN0B5 (1859360942)
#define	WeY4Gbs	(1160438554)
#define    r9C4f2056M    (-1456288769)


int main() {
  char  o3IGO5X8n7;
  o3IGO5X8n7  =  (char)98058239;
    unsigned short int    T19y3;
    T19y3    =    (unsigned short)-1967344567;
 unsigned char uP1X2_9k;
 uP1X2_9k = 0;
 unsigned int QLuILQ;
 QLuILQ = -1725988349;
 long long Km5x;
 ...
 s_6y54f = 1527445658;
	...
	m7Qw	=	768809681;
  unsigned short  iojs;
  iojs  =  (unsigned short)2125800771;
  unsigned short int  iqBroKc;
  iqBroKc  =  (unsigned short)-861589471;
  double  Adw6j8u3;
  Adw6j8u3  =  6874342;
  short  DnkBlkMQY;
  ...
  unsigned short  nNV6;
  nNV6  =  (unsigned short)-2018088718;
    float    b3Vl_4NZXJ;
  ...
  F9Feu43My  =  (unsigned char)1999632986;
	...
	w5hSHyx_1	=	863081394;
  unsigned char  dEW22;
  dEW22  =  (unsigned char)547311792;
	double	kL7P76nc9;
	kL7P76nc9	=	-1899585164;
    int    VFNI2_;
    VFNI2_    =    -1885409316;
 int TKUD1;
 TKUD1 = -616849116;
	unsigned short int	r3V4f3q2DP;
	r3V4f3q2DP	=	0;
...
for (int j = 0; j < 5; ++j)
{
U_kk512t21 = (int)floor(kL7P76nc9);
}
}
if (dEW22 & 276667117)
{
...
else if ((Km5x >= pk05) && (uP1X2_9k > QLuILQ))
{
switch (VFNI2_)
{
case 'a':
...
{
i++;
std::cout << "KSC27H4O" << TKUD1 << b3Vl_4NZXJ << X_rG << "P8jYf7" << std::endl;
}
while (i < 2);
}
...
if (TKUD1 <= WeY4Gbs)
{
std::cout << "M0yi6R" << iojs << "KCIu" << std::endl;
}
else
{
if ((kL7P76nc9 != WeY4Gbs) || (QLuILQ >= pk05))
{
w5hSHyx_1 %= o3IGO5X8n7;
}
else
{
dEW22 ^= pZ7Z95V3EX;
