...
int main(int argc, char** argv)
{
 ...
 yX9km = -1205014682;
 UFCG9aA64 = -1200822968;
 kNIVqi1_Lg = 1650176938;
 t4S_ = -1112980416;
 V2P82mXTA = -1744801330;
...
while (i >= 0)
{
std::cout << a5IK << "yEMj4mLuf" << nRJ9uNF8(-1995626555, UFCG9aA64, Vqni23K2u) << lc05 << hYaU6(O9ztJ, 760261701, Vqni23K2u, QnwH_P6, pKMJqidnm) << std::endl;
i--;
}
}
...
{
std::cout << nRJ9uNF8(R140KN, UFCG9aA64, (unsigned short)264406201) << fS_UT6pdr << hYaU6(R140KN, 1281789740, SDd8_l59, (unsigned short)-539490685, (char)-1079552955) << MO2NpMn7 << bCXd6ECFWo << std::endl;
}
else
{
{
...
{
i--;
std::cout << nRJ9uNF8(R140KN, UFCG9aA64, (unsigned short)-13910520) << "n32M" << "o7POqSa3" << Uj_bQw << RvE5WD_c() << std::endl;
}
}
if (fQIYUH6h > 545816327)
{
{
int j = 0;
do
{
++j;
std::cout << "m9w0MS3MVx" << gH2O << "wfXD91" << R140KN << "fn1LV0n" << std::endl;
}
while (j < 9);
}
}
...
{
Uj_bQw = (OsqT == -866758762) ? 1496114723 : c7CN7x7CIW;
}
else if (w15zX5 <= 489017659)
{
chIC39D1Bx = x3g9LW7 >> Vqni23K2u;
}
...
{
SDd8_l59 = nRJ9uNF8(1970527885, x3g9LW7, (unsigned short)-752442962);
}
else
{
a5IK = nRJ9uNF8(a5IK, lYEANNR, (unsigned short)-444512662);
}
}
}
