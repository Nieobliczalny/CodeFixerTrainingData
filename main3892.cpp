...
#define phTN87 (1086110569)
#define	ui7L9t_9A	(-1611583493)
#define  AbKm9  (-634893610)
#define  wqr1cxhS4  (115547698)
#define  RAzsT4i_7  (0)

using namespace std;

int  r690a(short  My0d)
{
  return  0;
}
...
int main()
{
  unsigned short  L85nT1k5p3,  OXy0G;
  L85nT1k5p3  =  0;
  OXy0G  =  0;
    ...
    FONd    =    -1410114548;
    a3w7cSD_j    =    -1266133543;
    p2_wsC    =    -1803650228;
    kq7rbLfc    =    1091659435;
    g5WPs    =    -1709384939;
    P9FdX0vm3W    =    -1642928704;
    ZWQ9K    =    1150853098;
    jh09Ms249    =    282662528;
    MhM_AJ    =    -80037147;
    WaY22a    =    406826590;
    yZAtx_0mq2    =    526983277;
    kDea    =    547149556;
    BJ6Ubp_BDk    =    262667304;
    KqSZ0WI    =    -284486573;
    O6u5rh12    =    -1898107663;
    y8L574Q3    =    704311926;
    yeR1S9    =    -691349578;
...
h11pi2I = g5WPs * BDd7n;
if ((j1PTs <= OXy0G) && (g5WPs & ui7L9t_9A))
{
OXy0G = r690a(KqSZ0WI);
}
...
{
Go0l503w = MhM_AJ * Lcp3cPV9p;
}
j1PTs = wqr1cxhS4 / IjCTNPK;

if (GLmNd45f > -1650784972)
{
GN6Y9++;
}
p8fHV27F = (unsigned long)(AbKm9);
switch (p8fHV27F)
{
case 'a':
...
if (Go0l503w & hGY4)
{
if ((HUA1_BS <= 2042012668) || (tjzy5912 < -976950272))
{
for (int k = 0; k < 5; ++k)
{
OXy0G = r690a(eA7Z2R_8d8);
}
}
else
{
...
{
if (P9FdX0vm3W >= ui7L9t_9A)
{
try
{
lMiT = GLmNd45f % 2054607175;
}
catch (int& errorCode)
{
OXy0G = r690a(690346278);
}
}
else
{
...
for (int i = 0; i < 3; ++i)
{
std::cout << "Ol0m_dd" << "vltU7WL" << "aT9y" << std::endl;
}

switch (OXy0G)
{
case 0:
rSf__9065 = OXy0G % 680196788;
break;
case 1:
OXy0G = r690a(yZAtx_0mq2);
break;
case 2:
...
{
std::cout << hGY4 << r690a(jh09Ms249) << "Cdot31Y5f" << std::endl;
}
}
...
{
std::cout << "vnGB7_hY" << "cP65ja3bcf" << IjCTNPK << std::endl;
}
...
do
{
u2s13mVnZ = (unsigned long)(ui7L9t_9A);
--i;
}
while (i >= 0);
}
...
{
case 0:
L85nT1k5p3 = r690a(ZWQ9K);
break;
case 1:
OXy0G = r690a(VnoC52Ix);
break;
case 2:
O6u5rh12--;
break;
case 3:
w5kULHL = (BJ6Ubp_BDk <= phTN87) ? j1PTs : -982811040;
break;
case 4:
MhM_AJ = FONd % p8fHV27F;
break;
case 5:
g5WPs /= sa0WR;
break;
...
OXy0G = r690a(BDd7n);
FONd -= 353452205;
if (L85nT1k5p3 == G25Tg8x5)
{
if (p2_wsC & -1055468730)
{
for (int k = 0; k < 10; ++k)
{
L85nT1k5p3 = r690a(Lcp3cPV9p);
}
}
}
return 0;
