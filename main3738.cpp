...
int main(void)
{
  int  q90mK1,  AVnvgk1,  asKq2H9;
  q90mK1  =  0;
  AVnvgk1  =  0;
  asKq2H9  =  0;
	unsigned int	desH2WhO5y,	xkyYn5gW,	M7T3,	Yd5kr2uO5,	u_U_;
	desH2WhO5y	=	892290663;
	xkyYn5gW	=	885386416;
	M7T3	=	470678154;
	Yd5kr2uO5	=	5067466;
	u_U_	=	398567330;

if ((q90mK1 != 1676833679) || (M7T3 <= xkyYn5gW))
{
...
else if (((u_U_ == asKq2H9) && (Yd5kr2uO5 <= -1901946977)) && (xkyYn5gW < asKq2H9))
{
if (xkyYn5gW == 846182279)
{
switch (u_U_)
{
case 0:
...
break;
case 3:
desH2WhO5y = dbxo878Utu(xkyYn5gW, desH2WhO5y, 1850295144, -731770572) % 887774501;
break;
case 4:
AVnvgk1 = dbxo878Utu(xkyYn5gW, (unsigned short)1416490945, Yd5kr2uO5, desH2WhO5y);
break;
case 5:
AVnvgk1 = dbxo878Utu(AVnvgk1, q90mK1, -1353275825, -1641126593);
break;
case 6:
asKq2H9 = (int)abs(q90mK1);
break;
case 7:
Yd5kr2uO5 >>= u_U_;
break;
...
else if (((M7T3 & 1739166967) && (xkyYn5gW <= M7T3)) && (desH2WhO5y <= AVnvgk1))
{
if ((u_U_ < -298037026) && (q90mK1))
{
for (int k = 0; k < 5; k++)
{
asKq2H9 = dbxo878Utu(asKq2H9, AVnvgk1, xkyYn5gW, 131455719);
}
}
}
...
{
std::cout << dbxo878Utu((unsigned short)1868373858, AVnvgk1, xkyYn5gW, Yd5kr2uO5) << "Iq5TZI" << "yRAjV" << std::endl;
}
if ((u_U_ < -1331530215) || (Yd5kr2uO5 != -274570514))
{
...
break;
case 3:
asKq2H9 = dbxo878Utu((unsigned short)431091617, u_U_, AVnvgk1, -2036427657);
break;
case 4:
...
break;
default:
AVnvgk1 = dbxo878Utu((unsigned short)-2118449884, desH2WhO5y, 2092042147, -660165631);
break;
}
...
{
AVnvgk1 = dbxo878Utu(Yd5kr2uO5, (unsigned short)500800046, 1522760371, q90mK1);
}
else if (asKq2H9 <= AVnvgk1)
{
Yd5kr2uO5 = dbxo878Utu(Yd5kr2uO5, xkyYn5gW, -1038982349, q90mK1) % desH2WhO5y;
}
else
{
AVnvgk1 = dbxo878Utu((unsigned short)-922518368, (unsigned short)700046552, AVnvgk1, xkyYn5gW);
}
}
catch (int& errorCode)
{
asKq2H9 = dbxo878Utu(939703579, q90mK1, 358808481, M7T3);
}
}
for (int i = 0; i < 1; i++)
{
...
{
j--;
AVnvgk1 = (int)(desH2WhO5y * AVnvgk1);
}
}
}
...
case 'd':
case 'D':
desH2WhO5y -= Yd5kr2uO5;
break;
case 'e':
case 'E':
asKq2H9 = dbxo878Utu((unsigned short)1654113841, (unsigned short)-603519735, xkyYn5gW, Yd5kr2uO5);
break;
case 'f':
case 'F':
...
case 'h':
case 'H':
q90mK1 = dbxo878Utu(q90mK1, (unsigned short)1755568964, -1395079050, asKq2H9);
break;
case 'i':
case 'I':
...
{
M7T3 = q90mK1 % desH2WhO5y;
}
}
desH2WhO5y = desH2WhO5y & Yd5kr2uO5;
std::cout << dbxo878Utu(q90mK1, xkyYn5gW, desH2WhO5y, Yd5kr2uO5) << std::endl;
return 0;
}
