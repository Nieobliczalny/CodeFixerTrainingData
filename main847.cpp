...
int main(int argc, char** argv) {
  ...
  unsigned short int  HT1VY91f  =  (unsigned short)-160498415;
  double  tOVyJG7e5N  =  -2038998189;
	double	DZQc3cV31	=	1527289969;
 unsigned short ndK9DP17 = (unsigned short)214100804;
 long double Md6vWG = 1521502644;
	int	UIf7Wp42	=	1197286611;
 ...
 int PF75Ot = 0;
    unsigned long    JcVKA    =    -2099053362;
  long long  EU3U  =  787269513;
    char    B5Ks_    =    (char)803038589;
    long double    zy6xUy    =    -639674785;
    unsigned char    AP57Y9k    =    (unsigned char)-540888720;
  unsigned short  g0M_UT_91Z  =  (unsigned short)1094110690;
    long long    Ams770    =    -623885371;
 double Dtl0 = -1338026302;
 short int oV5yQ1hd = (short)-1177660052;
	unsigned char	IjP0oz6	=	(unsigned char)-203055809;
    unsigned char    vQ__    =    (unsigned char)2113742836;
 unsigned short int t9U6h7DE42 = (unsigned short)87958404;
 ...
 unsigned short int QRT84U3E70 = (unsigned short)76563038;
	short	AWDB468	=	(short)2014011183;
 long long dZv89J3 = 1404473468;
    unsigned long    o6_5    =    1661301265;
 short KpUy6SRNk2 = (short)-1159221552;
  long long  Goz7y17Nz  =  -930553895;
	unsigned short int	w4h5v	=	(unsigned short)2035061563;
 float Su9_Qftsg = 306082043;
    short    c6Riky    =    (short)119451971;
	int	cjMPBk5V	=	-1332891505;
 short d21FNVD_6 = (short)2089081747;
  unsigned short int  RxE80  =  (unsigned short)970269313;
 unsigned char cD6Z931X = (unsigned char)-2113949152;
    short    P5_COl    =    (short)-206292125;
    float    WPnEw7ZX    =    1710811524;
  short  dt9II_  =  (short)180817091;
	unsigned int	jepC1MsXP	=	-2090625159;
	unsigned short int	a20IG	=	(unsigned short)683166219;
...
{
PF75Ot = LKI_R2d(-1114078301, -1797745979, -1926505279);
}
...
{
k++;
c6Riky = (int)abs(aWTx35Ztf);
}
}
}
catch (int& errorCode)
{
PF75Ot = LKI_R2d(EU3U, 1523927205, c6Riky);
}
}
while (i >= 0);
}
