...
#define    d8HN    (0)
#define  w1fC7  (377224690)
#define  DX20MoKC_  (783402694)
...
int main(void) {
 char UfmW = (char)60716302;
  char  W0Ne  =  (char)-1527582695;
  int  umU5m2W  =  1735819681;
 short bcU_zRQP = (short)847969735;
    double    WRAjAd    =    -2095726840;
 long Ap4EYp = 648011682;
    short    O2TvxX0y    =    (short)421862044;
	unsigned short	zd9GMp	=	(unsigned short)2119593822;
  long double  w7BIB  =  -1165946872;
 float yoJJk8 = -105861511;
 long X3t7 = 886810669;
    unsigned char    VNWFU_0Y5    =    (unsigned char)1348226140;
 ...
 unsigned short HWJSpV27 = 0;
  ...
  char  fp0R  =  (char)2085869516;
	...
	unsigned char	Ypoq9	=	(unsigned char)-1138469123;
  unsigned short  eQQrG62  =  (unsigned short)-1653552499;
 unsigned int l0fV = 1275920497;
  short  r68a  =  (short)-1242381609;
    short int    ex_k    =    (short)-1364890435;
  float  W3Ro4T3  =  563780715;
 unsigned int aZ1FotF7 = -413463292;
  float  XgG_E_TXnw  =  692294391;
	short int	y6Gfq4_wo1	=	(short)-11257081;
    unsigned char    NwfJA2Hb    =    (unsigned char)-1783949834;
    int    J3rh7    =    0;
    unsigned int    H5_L77    =    -2069262891;
    unsigned char    xk4jhC_6x    =    0;
 unsigned short K4X6zY2XFY = (unsigned short)312663289;
    char    g1sLvy7B    =    (char)-528365087;
	unsigned short int	n_57i7_B	=	(unsigned short)-1022145119;
 long Ao_wugi9 = -255845513;
 long double zMv7rRe = -526616050;
	unsigned int	uAOo	=	-2120123883;
  unsigned long long  k1HzzQty  =  1491539729;
	char	M2396n0	=	(char)515573149;
    double    NL69e62O    =    1586251451;
	long double	h54Hu	=	1797068475;
	unsigned char	HpcLLp0	=	(unsigned char)-633007602;
 ...
 short int EUzkP = (short)958200221;
  float  m2fa9i4  =  385777292;
    ...
    int    YR5W    =    -2042893229;
    unsigned short    q7_8BxgO    =    (unsigned short)69392790;
	int	vKicvoHB	=	-157155601;
 unsigned char OX4t_6Iuf = 0;
  short int  j6488b_0_I  =  (short)912027731;
	short int	Z2osGPuCa1	=	(short)-1190144860;
 unsigned long long qfv_pQ_ = 460803539;
    unsigned short    l3_WF1z1l1    =    (unsigned short)-989689037;
 short Sa469s = 0;
    float    lGgcNvk77    =    -1046613651;

zMv7rRe = netd7();
K5n6 = VC_1((unsigned char)-288333443, 1681314116, y6Gfq4_wo1);
...
{
NL69e62O = (int)floor(h54Hu);
}
else if ((Ao_wugi9 <= zd9GMp) && ((zd9GMp == w1fC7) && (Ypoq9 < -140173220)))
{
...
if (hRPcU3AB >= d8HN)
{
q7_8BxgO = (unsigned short)(NL69e62O);
}
else if ((J3rh7 & d8HN) && ((j6488b_0_I > 652540130) || (k1HzzQty <= -848262737)))
{
for (int k = 5; k >= 0; k--)
{
xk4jhC_6x = Hy4F1x8f();
