...
#define zoT_B9Jb (0)
#define	MWa_3Q	(1829294471)

using namespace std;

unsigned char	J1fp4(unsigned short	L44Q,unsigned short	Sz0ZN_5,unsigned short int	V41wl86_8m,long long	fs79);
...
int dVb_GkO(short int LBHw527);

int main()
{
    char    Y3o6706Ez    =    (char)-925482409;
 ...
 unsigned long long X1ExpO = -1583679086;
 int lF0_94r = -1483167946;
  unsigned long  zvn40A  =  967227878;
  float  m064  =  1118962532;
 ...
 unsigned short int VMq80 = (unsigned short)-703388758;
    long long    Qv6Dg_6J8    =    -2087052111;
  unsigned char  iyB939p6oE  =  (unsigned char)-159437827;
 float zQs90ALv4 = -70065905;
    unsigned short int    wBTt6H    =    (unsigned short)1336062262;
 unsigned long long UV_xsrSL = 65793883;
    unsigned int    Pe7fK49p8    =    -1868589896;
 unsigned short Q7A_1bbD7 = (unsigned short)-1121186689;
  long  hYz7nr3Sy  =  843645419;
	long	buM64QjXg	=	-351121943;
 ...
 unsigned short int SarMmi5 = (unsigned short)843056372;
  ...
  unsigned short  BL0Y1  =  (unsigned short)-378989796;
 ...
 long double Se58zB = -1174496465;
	long	IukSMuP122	=	-946487449;
  unsigned long  muZ_G_Uz1q  =  -265978159;
    unsigned char    jf_G74_    =    (unsigned char)-867395825;
  float  W_37h_I9_  =  243426147;
    char    Zo9C8_    =    (char)-420981978;
  unsigned short int  B3M3knWX  =  (unsigned short)-1174450499;
  unsigned short int  i6d216  =  (unsigned short)-2126271013;
  unsigned short int  ghIw  =  (unsigned short)-602281185;
	unsigned short int	Kv2Sg_kc4	=	0;
	unsigned int	LS08gRyqL0	=	153435211;
  unsigned long long  ZVZp15I  =  1041591326;
  unsigned short int  a7w_l47Jmd  =  (unsigned short)66263502;
...
break;
case 3:
iyB939p6oE = dVb_GkO((short)1356845036);
break;
case 4:
Ybea7R7 = UEx4 - 982899217;
break;
case 5:
I77bfT = (int)ceil(OikxC);
break;
}
}
else
{
Zo9C8_ = a7Z96L(iyB939p6oE, (char)-400649860, I77bfT) ^ O7r156;
}
++i;
}
while (i < 9);
...
case 'e':
case 'E':
vbSWbfg6vL = a7Z96L((char)-741657578, (char)526814931, lF0_94r);
break;
default:
...
{
O7r156 = a7Z96L(O7r156, 915709727, 1378226243);
}
cout << "FTG3894Vi5" << "Jx5PgNq2M3" << W_37h_I9_ << endl;
cout << dVb_GkO(O7r156) << IOgF << endl;
switch (X1ExpO)
{
case 0:
...
break;
case 2:
LS08gRyqL0 = dVb_GkO((short)401210860);
break;
case 3:
LS08gRyqL0 = a7Z96L((char)1343798174, W_37h_I9_, -778442220);
break;
case 4:
...
break;
case 7:
Q7A_1bbD7 = dVb_GkO((short)1801421615);
break;
}
...
{
case 0:
hYz7nr3Sy = a7Z96L((char)854580479, UEx4, 2145202935);
break;
case 1:
...
break;
case 4:
tWa8Pq6T9C = dVb_GkO((short)785810431);
break;
case 5:
...
case 'd':
case 'D':
UEx4 = qs9nWJl_1A(1186122182, 1278871539, 574720520, -2067825679);
break;
case 'e':
case 'E':
Zo9C8_ -= Se58zB;
...
tWa8Pq6T9C = a7Z96L(tWa8Pq6T9C, (char)-820940360, zVff87h_h);
switch (G_QN)
{
case 0:
...
char qs9nWJl_1A(int z3M5jlC_,long HSyZ215,int VCU60,long long I_YI3) {
 return (char)-585106576;
}

char	a7Z96L(char	IA3arf7QI,char	z_Jp,unsigned int	a6Ri)
{
	return	(char)1460527039;
}
