...
int main(int argc, char** argv) {
 ...
 Lxfk7Nyv = (short)-487614288;
  ...
  VK_LIn  =  (unsigned short)-2007696354;
 int UWMj400_Q;
 UWMj400_Q = 5227661;
 unsigned long long H6B651njar;
 H6B651njar = 445690978;
  ...
  o3_L96  =  -348575971;
	short int	hN3V_1O_;
	hN3V_1O_	=	(short)163700681;
	unsigned int	STXp033zBl;
	STXp033zBl	=	700387020;
    unsigned short    gf1yHs5j;
    gf1yHs5j    =    (unsigned short)-1918783655;
    unsigned char    Au84;
    Au84    =    (unsigned char)-158516313;
  float  Jr7ByQ84;
  Jr7ByQ84  =  1344599428;
 unsigned short int GCAym8jeZ;
 GCAym8jeZ = (unsigned short)1378694364;
	float	sD7OLza;
	sD7OLza	=	-2111405539;
  unsigned short int  BwpGZiIu4;
  BwpGZiIu4  =  (unsigned short)445758660;
  unsigned int  R5X2;
  R5X2  =  290505842;
	short int	r2_E9_H;
 ...
 s67Z_6d26 = 1884163994;
  ...
  E470O  =  -729288803;
    ...
    zuG4O83C    =    0;
  short  cGzy64;
  cGzy64  =  (short)-1013393841;
  double  a_MU4bze9v;
  a_MU4bze9v  =  838262556;
	unsigned long long	o1aEf;
	o1aEf	=	216745664;
 long yeJovag_J;
 yeJovag_J = -1591697219;
  ...
  nBpJ7GyT3  =  (unsigned short)-120097986;
 short int r61ljB;
 ...
 Sqtp = 1815335898;
  ...
  S2Clilgm  =  (unsigned char)-863154805;
 ...
 wB_FXOeq = -2026020312;
	...
	AWHRS4Q5ka	=	877703825;
	float	h91wxx7qnj;
	h91wxx7qnj	=	1734519395;
    unsigned short int    cuTj34O;
    cuTj34O    =    (unsigned short)285160501;
...
{
case 'a':
E470O = (int)abs(hN3V_1O_);
break;
case 'b':
r61ljB = o1aEf % 1201464405;
break;
default:
jZK4oj0M8 = (int)ceil(Z0I1);
break;
}
++i;
}
...
{
PHZjFNR = (long long)(vTfX);
}
}
else if (gbeG4T > 1605006348)
{
for (int j = 5; j >= 0; --j)
{
AWHRS4Q5ka /= TvZdsKC;
...
else if (Jr7ByQ84 > -2000996209)
{
std::cout << U9n3L << std::endl;
}
else if ((AWHRS4Q5ka == bM4i5) && (OimOjKU == -458400672))
{
...
{
std::cout << bIAh9R << "SEQdokWMa" << Tj2Re6R7q << "CI3r95ip" << Tj2Re6R7q << std::endl;
}
else if (o1aEf < STXp033zBl)
{
switch (Au84)
{
case 'a':
...
case 'e':
case 'E':
x58_h98S4X <<= 244203351;
break;
case 'f':
case 'F':
Sqtp = (S2Clilgm & ylV4) ? 908563917 : -355157583;
break;
}
...
{
++i;
UWMj400_Q |= 1742964754;
}
while (i < 9);
}

gm9xP4 = TvZdsKC | o5pyPg;
