...
int main() {
	unsigned int	Vv2Qb,	VorZRM_,	H3UV;
	Vv2Qb	=	0;
	VorZRM_	=	0;
	H3UV	=	0;
    ...
    UNgagyHs2    =    -900960987;
    nb0_Sv    =    232091528;
    RnAJA27vfo    =    2027264091;
    szX6yhV    =    -393680179;
    q3VEdT    =    479266342;

eWaMvJoU_p = F8051tWZ9b / H3UV;
try
{
if ((Vr7KJ699) || (sCF7x > -771954191))
{
if ((H3UV & -575214566) && (bu53Vk >= 1643399490))
{
h43278 = Z84H(h43278, (unsigned short)-1314040442);
}
}
else if (uV4_8aK7BF)
{
...
{
if ((nb0_Sv != v4_5Y) && (CKamMubt < 1420407158))
{
n9pweo12W5 = (int)floor(DDIn3T7f1);
}
else if (vKy3efB < -1542145450)
{
VorZRM_ = NY695_J();
}
...
{
xbiJzWv = Jz0yH7(1455133165);
}
if (O2fT == s00F9)
{
F8051tWZ9b = (int)ceil(hiJCgL6);
}

std::cout << r3GZbL << jg0Q1mBC_ << std::endl;
z3dO_ = (int)abs(bq36wm99);
...
break;
case 1:
EOJlT = Vr7KJ699 / 165991858;
break;
case 2:
O_17Y = (int)ceil(fvcZ2ocq);
break;
case 3:
enBweB2u = Jz0yH7(enBweB2u);
break;
case 4:
AY_qvCC1 = Z84H(2125709605, (unsigned short)-1434115627);
break;
case 5:
x4YZh_R = t_74F / F2k1A1_;
break;
}
for (int i = 0; i < 4; ++i)
{
M2hHkSvso = (int)abs(gtwTl);
}
std::cout << "AxinMRqXd" << std::endl;
return 0;
}
