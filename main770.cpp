...
int main(void)
{
 ...
 T5GH = 1084712342;
	...
	SSn162qjdP	=	(unsigned char)-225036271;
    float    gONxIYUc;
    gONxIYUc    =    -1786598347;
    long    XK_8;
    XK_8    =    -294253368;
  unsigned char  nOw9ZG53L;
  nOw9ZG53L  =  (unsigned char)2116595008;
 long long y6Yvv;
 y6Yvv = -1824181518;
 ...
 DMf1W1 = 890274864;
    ...
    FurRM0I    =    1510656071;
 long FWdO60EWFA;
 FWdO60EWFA = 1785590901;
  char  yTG4A0yU4;
  yTG4A0yU4  =  (char)1631682002;
  int  W779;
  W779  =  163817405;
    unsigned char    j3X_;
    j3X_    =    (unsigned char)897927429;
 long long w6mN5Y1;
 w6mN5Y1 = -541209049;
    int    xRw_HH5;
    xRw_HH5    =    1158023410;
...
else if (freg65_ >= xRw_HH5)
{
FurRM0I = (int)abs(FWdO60EWFA);
}
else
{
switch (Zj2D)
...
wzrNwcG = GTlH5xM / BaK4;

if ((T1lZM1 <= enD2u1Y_8) || (gONxIYUc <= GTlH5xM))
{
