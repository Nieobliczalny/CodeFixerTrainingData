...
#define    Gw2_4    (0)
#define	O50_60	(-571834471)
#define h77v6R (1498323101)
#define  G8ZS_4Ha  (-1774016111)
...
int main(int argc, char** argv) {
  ...
  unsigned int  l335  =  439051666;
    ...
    unsigned short int    tu8sRS    =    (unsigned short)1812149379;
 unsigned long long fwT4zR = 311377947;
 unsigned long long w18Ft = -307690764;
 short int KW7e = (short)-298410420;
 short int ql24k9 = (short)-1773381970;
  unsigned char  BfH9OXNP7f  =  0;
  short  f1D5XXc  =  (short)1075245726;
  long double  X083dn_vJ  =  1018603482;
	char	vDxdC3j8	=	(char)-267497317;
 unsigned short CR0ZS5_p8_ = (unsigned short)1468438434;
  ...
  unsigned short  EZP5  =  (unsigned short)-2100322408;
	...
	int	pxn6a81	=	-1482254745;
	short	fM47NZi	=	(short)1235121507;
	short	gWE1q8	=	(short)242029796;
	unsigned long	ivgij	=	-1410791988;
  unsigned short  tP8c1mBC  =  (unsigned short)1650941733;
	long double	Vd056	=	229663690;
	unsigned int	zwjHAycs	=	326362064;
  float  qx9o_16Xw  =  -1885472153;
	long long	BaFx7AD1	=	-1372059495;
...
{
xQ41al5i = bM7W_2_(W63z, lKF_h, 376019177, -380538249);
}
switch (fwT4zR)
{
case 0:
...
break;
case 1:
BfH9OXNP7f = bM7W_2_((short)1145185896, 117410502, -1938363172, (unsigned short)819766575);
break;
case 2:
...
if (BaFx7AD1 != tu8sRS)
{
std::cout << vDxdC3j8 << "dSV3cV" << bM7W_2_(zwjHAycs, qA45Siw_Cb, e4iZ60, (unsigned short)-1307584761) << std::endl;
}
}
catch (int& errorCode)
{
BfH9OXNP7f = bM7W_2_(-1071810257, jL1vd, Js69GqZ1M, ILSOE3lq);
}
for (int i = 0; i < 2; ++i)
{
