...
int main(int argc, char** argv)
{
 ...
 double k7GoP;
 k7GoP = 507009000;
	unsigned short	O_a_a551gP;
	O_a_a551gP	=	0;
  long  z_f770;
  z_f770  =  -1397697355;
	char	GdRUhLbU;
	GdRUhLbU	=	(char)-1320876697;
    int    tH9F5;
    tH9F5    =    1116066157;
 char j8qp_KsF;
 j8qp_KsF = (char)-121800217;
 long double wVskBXGJ;
 wVskBXGJ = 1686517855;
 char OQIDCJ0;
 OQIDCJ0 = (char)824378053;
  float  ajd521af;
  ajd521af  =  1681853217;
	unsigned short int	fsAM92;
	fsAM92	=	(unsigned short)-786780005;
 ...
 YFj_fz = (unsigned char)-1783287138;
  ...
  znp7S  =  -1309641655;
    ...
    char    HQNk9rm;
    HQNk9rm    =    0;
    unsigned long    OD0EEpg0AA;
    OD0EEpg0AA    =    1599717513;
    unsigned long    QJ3b9q_bqA;
    QJ3b9q_bqA    =    2089515380;
  short int  Lt10215;
  Lt10215  =  (short)1580645677;
  long long  B66263AmG0;
  B66263AmG0  =  -871166535;
 unsigned short int ob3nE647w;
 ob3nE647w = (unsigned short)1198888131;
 long Em2_P;
 Em2_P = -659192795;
    unsigned short    xDqUX1;
    xDqUX1    =    (unsigned short)1860788857;
	float	W_1Re;
	W_1Re	=	-1719140865;
 ...
 tvXV9ywt5 = 1983065270;
  char  hco_7G;
  hco_7G  =  (char)1801806878;
 long na2rx7554;
 na2rx7554 = 0;
	double	R5qXJ0Z58;
	R5qXJ0Z58	=	-947367613;
 unsigned long qSk761K;
 qSk761K = 0;
	unsigned int	cy49;
	cy49	=	-1669517603;
  short  fInz_;
  fInz_  =  (short)2050307568;
 float Ll_E932q4;
 Ll_E932q4 = -2092438604;
  unsigned int  HxSMVPrLzm;
  HxSMVPrLzm  =  -1364515210;
  char  t3S9jJ2Rg;
  t3S9jJ2Rg  =  (char)-1602222468;
 unsigned int d2G616;
 d2G616 = -2044845649;
 ...
 u2m3C_ = -1648283422;
  ...
  Q2JMA74GlX  =  (unsigned short)1591866577;
  unsigned long  Fk1dFF;
  Fk1dFF  =  -538743507;
  int  r3fKM;
  r3fKM  =  204304903;
	long	Bea7HH9Nf9;
	Bea7HH9Nf9	=	692088271;
    short    rJV_K;
    rJV_K    =    (short)-1389141664;
  short int  d92M9;
  d92M9  =  (short)-678777821;
 short qMjrvTY;
 qMjrvTY = (short)456410514;
	int	fyKBIGg4iP;
	fyKBIGg4iP	=	577773354;
...
if ((Em2_P) && (QJ3b9q_bqA))
{
fsAM92 = Fk1dFF | Bea7HH9Nf9;
}
else if (fRp6I3ffwI == r3fKM)
{
HQNk9rm = jbY5_(d2G616, (unsigned char)-1908057300, AY22zL_6);
}
...
for (int k = 2; k >= 0; --k)
{
fyKBIGg4iP %= 541965600;
}
}
}
catch (int& errorCode)
{
bCxvi1NKd = (int)abs(Ll_E932q4);
}
...
{
d92M9 = (int)abs(z_f770);
}

Ll_E932q4 = q9Y5dp1255();
...
while (k >= 0)
{
na2rx7554 = jbY5_((char)-1333616295, YFj_fz, -555289154);
k--;
}
}
}
...
if (qSk761K)
{
qMjrvTY = (int)abs(Lt10215);
}
else if ((wubQCK < ajd521af) && (fRp6I3ffwI < tvXV9ywt5))
{
GdRUhLbU = q9Y5dp1255();
}
else
{
O_a_a551gP = jbY5_(j8qp_KsF, (unsigned char)-1219997301, GdRUhLbU);
}
++j;
}
}
...
{
rJV_K = (O_a_a551gP == 753020403) ? 157522601 : q9Y5dp1255();
}

if ((677273271 / O_a_a551gP) >= 525954768)
{
...
while (j < 6)
{
O_a_a551gP = jbY5_(QJ3b9q_bqA, (unsigned char)-768048842, qMjrvTY);
++j;
}
}
}
qSk761K = jbY5_((char)-195559304, Bea7HH9Nf9, fLiGuYL);
return 0;
}
