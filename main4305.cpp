...
#define mers5euY (427868133)
#define	IAz7ZLz	(0)
#define    Ius_i3YPOV    (1520542718)
...
int main(void) {
    unsigned int    AgjH0bdf,    LqVSZn,    ESb0e1,    buFt,    l4cQJ,    i7w9,    QXeXF_m,    K_tcKpLz1y,    lOi_MmkO,    zFjFkPeK9,    nrQR;
    AgjH0bdf    =    392086494;
    LqVSZn    =    1260206965;
    ESb0e1    =    36856578;
    buFt    =    1979405299;
    ...
    nrQR    =    -1203743527;
	long	xsxY,	Y_5CqCq,	ICH6dOYUT,	tKUnty0n,	BQ7qI5;
	xsxY	=	0;
	Y_5CqCq	=	0;
	ICH6dOYUT	=	0;
	tKUnty0n	=	0;
...
BQ7qI5 = hN_LN8v(BQ7qI5, (unsigned short)-935661507, (unsigned char)-1152032688, (short)837345899);
try
{
...
{
nrQR = f8P_6m(-2132745601, ICH6dOYUT, -1712701668, Y_5CqCq);
}
}
if (QXeXF_m & Ius_i3YPOV)
{
LqVSZn++;
}
else if (tKUnty0n)
{
tKUnty0n = (long)(ICH6dOYUT);
}
else if (LqVSZn <= i7w9)
{
switch (nrQR)
...
break;
case 'b':
K_tcKpLz1y = yS36M1uz(BQ7qI5, -258519416);
break;
case 'c':
...
else if ((zFjFkPeK9 < 1049439164) || ((Y_5CqCq & -376663593) && (nrQR > QXeXF_m)))
{
if (tKUnty0n >= ESb0e1)
{
for (int k = 0; k < 8; ++k)
...
for (int k = 7; k >= 0; k--)
{
LqVSZn = Ius_i3YPOV * lOi_MmkO;
}
}
}
else if (i7w9 <= 1663978407)
{
BQ7qI5 = hN_LN8v(l4cQJ, (unsigned short)1905869476, (unsigned char)-1502599490, (short)-366442457);
}
...
{
--j;
std::cout << "oCfV2g91E2" << hN_LN8v(LqVSZn, (unsigned short)-711004327, (unsigned char)-1699757693, ESb0e1) << std::endl;
}
while (j >= 0);
}
}
...
break;
case 2:
ICH6dOYUT = hN_LN8v(ICH6dOYUT, (unsigned short)5096393, lOi_MmkO, (short)2063339170);
break;
case 3:
lOi_MmkO *= 1063422481;
break;
...
for (int i = 0; i < 2; i++)
{
ESb0e1 = f8P_6m(1899206125, ESb0e1, i7w9, 2074483164);
}
