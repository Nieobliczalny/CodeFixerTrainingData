...
int main(void) {
  unsigned int  r8M40sPi3I  =  1167956433;
 long double K_yO02 = 1898468046;
 unsigned char hW7M4h66XR = 449926721;
  unsigned long  l7Kt_bh8Z2  =  1987767762;
  double  zUgEa3  =  -1174309386;
	unsigned short	emV1v	=	1774664291;
 int Z6buDRA = 0;
  ...
  unsigned char  O45f76  =  -287183024;
    ...
    short int    sXXW09m    =    -1190689732;
 short bzLrLdL = 559047211;
  unsigned char  UGb0FI7Upr  =  656248046;
    long double    JRTjb8sVs    =    -1713106480;
  double  PZ42t0  =  -16465124;
  short int  QX3P  =  0;
  unsigned int  Q4Rx8ChQ8e  =  -1816344216;
	float	r4d4u2FiB	=	907284785;
    float    FOVqI3Y1v    =    -127317259;
	unsigned int	t_qzzzw	=	-661853617;
  unsigned long  rHe1  =  395998417;
    unsigned char    CzI4r    =    -1173156372;
 unsigned long yZIk = -1237669842;
	unsigned short	O99r	=	632245871;
 ...
 unsigned long Q3KvN24GNH = 2065586021;
	unsigned short int	cO6p	=	608377063;
    long double    SEE4lXRQ5    =    -268448108;
	unsigned int	JkV0	=	-761098137;
  double  UxI0  =  1349042663;
 long long a0gtZl = -1816816381;
  int  tSZG  =  -1067751325;
	long double	uV8X3i9Fdm	=	-1056558792;
  short  I6_W3Lm_p  =  -53888464;
 float es848 = -971817399;
 short wV2B = -1455914585;
  unsigned short  p60M_8fL51  =  0;
 long double lB9P4 = 1172900855;
    int    wqFR    =    617100100;
  long  iyu1s2  =  -1654469649;
  long  eDbMR  =  -652087425;
 unsigned short int kp4GC6 = -1275991722;
  long  Aug22  =  -194603985;
 unsigned short KfPo = -1887436425;
	int	iJCKKB6M	=	-1023435943;
  short int  ywH9bap5  =  1787539676;
    unsigned short    VPo_P2    =    942732078;
 ...
 long TZ9A8y = 1765806879;
    int    d4fSo    =    2046160649;
    long long    TaZ7    =    -515493104;
  short  IPj_  =  0;
    long long    gw179j6nVj    =    442923046;
	unsigned short int	TKG0io	=	844176950;
    unsigned long long    UYiS4Z    =    -1674833792;
  unsigned long  nx0KPpF8c  =  1720973399;
  long long  GB705  =  -17674560;
    unsigned long long    dlHE    =    -2083019948;
 unsigned char Bn_2 = -715993003;
 ...
 unsigned long V_ME9Vm = 384105776;
  ...
  unsigned long  NpChPl4tw6  =  776542860;
    short int    P7qC9F1M    =    525207653;
	long long	FCdFSHc4Zs	=	-825377142;
 short AJ2qW = 1888984387;
	double	VGdo0l	=	2056250049;
    unsigned int    GCF4M2Rmm    =    480277625;
 short oQ2RPSKYjd = -1482817589;
  int  XM5n34Cz9  =  559910302;
 int Zracoj5R = -1439003049;
    unsigned long long    dZ6b    =    -994913288;
 char V6eT1G039 = 418000787;
 char F05WU6 = -1655609024;
...
{
i--;
std::cout << zxqgbq(538879018, -1149431770, -51643925) << zxqgbq(-59580630, gYkIXPr2, AJ2qW) << "M2C34" << zxqgbq(848386205, gYkIXPr2, AJ2qW) << ywH9bap5 << std::endl;
}
while (i >= 0);
}
return 0;
