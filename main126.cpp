...
unsigned int  NQ_4479l6(unsigned short int  nHFre,unsigned short int  Nypwp7_3,int  r0O50nGO8)
{
  return  0;
}
...
cout << NQ_4479l6((unsigned short)1984172349, VE25u, D8Lf) << NQ_4479l6((unsigned short)-1731953643, (unsigned short)632261536, 815773262) << NQ_4479l6(H781w3_Eh, VE25u, D8Lf) << "V3_KS0y9" << "SUMJUcA8bj" << endl;

switch (E8g5)
{
case 'a':
I3bbd = (I3bbd == iCpN9N) ? NQ_4479l6(H781w3_Eh, VE25u, D8Lf) : ac5h68n;
break;
case 'b':
I3bbd <<= H781w3_Eh;
break;
...
VE25u = -1095924026 / NQ_4479l6(VE25u, I3bbd, 673815026);
for (int i = 0; i < 9; ++i)
{
switch (H781w3_Eh)
{
...
if (E8g5 != H781w3_Eh)
{
I3bbd = (int)abs(hC485XQW);
}

cout << NQ_4479l6(iCpN9N, hC485XQW, ac5h68n) << endl;
